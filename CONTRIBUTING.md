# Contributing to can-model-queue
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-model-queue) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-model-queue, you can start by going to its [fork page](https://github.com/canjs/can-model-queue/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-model-queue
```
